                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Update category details for <span class="font-medium text-gray-700 dark:text-gray-300">{{ $category->name }}</span></p>
                        </div>
                    </div>
